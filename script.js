...
const citiesApi = './dataBase/cities.json',
   // proxy = 'http://cors-anywhere.herokuapp.com/',
    API_KEY = '31ccd991846206cd56dbb3d11916f9ab',
...
const createCard = (data) => {
    ...
    if(data){
        ...
        deep = "<h3>К сожалению, билетов на выбранную дату нет</h3>";
    }
...
formSearch.addEventListener('submit', (event) => {
    ...
    document.querySelector('.correctly_name').style.display = 'none';
    ...
    if(formData.from && formData.to){
        ...
        document.querySelector('.correctly_name').style.display = 'block';
    }
});
